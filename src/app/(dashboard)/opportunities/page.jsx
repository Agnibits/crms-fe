      ...
      >
        {opportunities.length === 0 ? (
          <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed p-4">
            <p className="text-xs text-muted-foreground">Drop opportunities here</p>
          </div>
        ) : (
        ...
        cell: ({ row }) => (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" onClick={(e) => e.stopPropagation()}>
              ...
              <DropdownMenuItem
                onClick={() => router.push(`/opportunities/${row.original.id}/edit`)}
              >
                <Pencil /> Edit
              </DropdownMenuItem>
              <DropdownMenuItem
      ...
      <Tabs defaultValue="list">
        ...
        <TabsContent value="list" className="mt-4">
          <DataTable
            ...
            emptyDescription="Try adjusting your search or filters, or add a new opportunity."
            toolbar={
              <Select
            ...
            actions={
              <Button
                variant="outline"
                onClick={() =>
                  exportToCsv(list.data?.items ?? [], "opportunities.csv", [
                    { key: "name", label: "Name" },
